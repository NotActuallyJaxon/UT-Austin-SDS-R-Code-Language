...
***
# <span style="color:#FF3333;">**Packages:**</span>
## rvest (Used for reading and importing html)
[Cheat Sheet](https://cran.r-project.org/web/packages/rvest/rvest.pdf)
```{r class.source="watch-out"}
#install.packages("rvest")
#library(rvest)
```
## sas7bdat (Reads sas7bdat files)
[Cheat Sheet](https://cran.r-project.org/web/packages/sas7bdat/sas7bdat.pdf)
```{r class.source="watch-out"}
#install.packages("sas7bdat")
#library(sas7bdat)
```
## stringr (Manipulate and navigate strings)
...
#library(lubridate)
```
## nycflights13 (dataset for New York City departing flights)
[Cheat Sheet](https://cran.r-project.org/web/packages/nycflights13/nycflights13.pdf)
```{r class.source="watch-out"}
#install.packages("nycflights13")
#library(nycflights13)
```
## rmarkdown (Rmarkdown files)
[Cheat Sheet](https://evoldyn.gitlab.io/evomics-2018/ref-sheets/rmarkdown-cheatsheet-2.0.pdf)
```{r class.source="watch-out"}
#install.packages("rmarkdown")
#library(rmarkdown)
```
## kableExtra (Better tables)
[Cheat Sheet](https://haozhu233.github.io/kableExtra/awesome_table_in_html.html)
```{r class.source="watch-out"}
#install.packages("kableExtra")
#library(kableExtra)
```
## ggplot (Better graphs)
[Cheat Sheet](https://github.com/rstudio/cheatsheets/blob/main/data-visualization.pdf)
```{r class.source="watch-out"}
#install.packages("ggplot2")
#library(ggplot2) 
```
## tidyverse (Includes a variety of packages containing useful functions)
[Cheat Sheet](https://res.cloudinary.com/dyd911kmh/image/upload/v1676302697/Marketing/Blog/Tidyverse_Cheat_Sheet.pdf)
```{r class.source="watch-out"}
#install.packages("tidyverse")
#library(tidyverse)
```
***
# <span style="color:#FF3333;">**Environment Management:**</span>
...
```
***
# <span style="color:#FF3333;">**Options And Functions:**</span>
## Scientific notaton removed
```{r class.source="watch-out"}
#options(scipen=999)
```
***
# <span style="color:#FF0066;">**Math Operations:**</span>
## Basic math
```{r class.source="watch-out"}
#1+2
#3-1
...
```
***
# <span style="color:#FF0066;">**Built In Functions:**</span>
...
```
***
# <span style="color:#FF0066;">**Creating Variables:**</span>
## Assigning variables
```{r class.source="watch-out"}
...
```
***
# <span style="color:#9966FF;">**Importing And Exporting:**</span>
...
```
***
# <span style="color:#9966FF;">**Navigating Datasets:**</span>
## Navigating data 
```{r class.source="watch-out"}
...
```
***
# <span style="color:#9966FF;">**Subset, Manipulate Data:**</span>
## Creating Subset 
```{r class.source="watch-out"}
...
```{r class.source="watch-out"}
#arrange(dataset, (ColumnToArrangeBy)) will sort alphabetically/numerically
#Make -(ColumnToArrangeBy) to order descending
```
***
# <span style="color:#9966FF;">**Reshaping Data:**</span>
## Lengthening Data
```{r class.source="watch-out"}
...
```
***
# <span style="color:#9966FF;">**Managing NA:**</span>
## NA Shenanigans
```{r class.source="watch-out"}
...
```
***
# <span style="color:#9966FF;">**Strings:**</span>
...
#str_split(x, " ", simplify=TRUE) #Returns a dataset with each element of x in a separate column and the text separated by " " being put into rows of that column.

#str_sub_vec = as.vector(x) #Returns a vector of x
```
***
# <span style="color:#9966FF;">**Loops:**</span>
## Loop Basics
```{r class.source="watch-out"}
#for (i in 1:n){
#  print('hellow world!')
...
```
***
# <span style="color:#9966FF;">**Conditions:**</span>
## If/Else Statements
```{r class.source="watch-out"}
#if (condition) {
#  Code
...
```
***
# <span style="color:#CC00FF;">**Online Data:**</span>
## Getting Data
```{r class.source="watch-out"}
#library(sas7bdat)
...
***
# <span style="color:#3366FF;">**Plotting In Base r:**</span>
...
```
***
# <span style="color:#3366FF;">**Basic Tables:**</span>
...
```
***
# <span style="color:#009999;">**Ggplot Essentials:**</span>
## Adding to graph code
```{r class.source="watch-out"}
#+labs(title="",x="",y="") #changes default axis labels and graph title
#+theme(axis.title.x=element_blank(),axis.title.y=element_blank(),) #removes axis labels
#+theme(axis.text.x=element_blank(),axis.text.y=element_blank()) #removes axis text on ticks
#+theme(axis.ticks.x=element_blank(),axis.ticks.y=element_blank()) #removes axis tick marks
#+theme(axis.text.x=element_text(angle=angle,hjust=1)) #hjust1=align top, hjust0=align bottom, no hjust=align middle

#+theme_classic() changes to blank white screen
#+theme_dark() changes background to grey square grid
#+theme_linedraw() changes background to grid
#+theme_void() removes all ticks,axis lines, and grids 
```
## Must define ggplot objectfirst(Must do every time data set is updated) 
```{r class.source="watch-out"}
#bw_ggplot <-ggplot(birthwt) 
#bw_ggplot + geom_bar(aes(x=smoke)) 
#bw_ggplot + geom_histogram(aes(x=bwt)) bw_ggplot + geom_point(aes(x=lwt,y=bwt))
```
...
```{r class.source="watch-out"}
#bw_ggplot + geom_histogram(aes(x=bwt,fill=smoke), alpha=.5,
#binwidth=250, position='identity')
```
...
```
## Ttitle and global options at top must be formatted exactly as seen
***
# <span style="color:#009999;">**Rmarkdown:**</span>
## File header and formatting
```{r class.source="watch-out"}
#---
#title: "Library"
#author: "Jaxon Lara - SDS 313 UT Austin"
#output:
#  html_document: 
...
```
## Suppressing Code(visual code in report)
```{r class.source="watch-out"}
#{r, echo=FALSE}
```
## Suppressing Output
...
```
***
# <span style="color:#009999;">**Tidyvers Functions:**</span>
## Combining Datasets
```{r class.source="watch-out"}
...
## Filtering Data
```{r class.source="watch-out"}
#filter(dataset, (conditios))
```
***
# <span style="color:#009999;">**KableExtra Essentials:**</span>
## Tables
```{r class.source="watch-out"}
...
```
***
# <span style="color:#009900;">**Date Parsing/Format:**</span>
## Date And Time
| Description                   | Code |
|-------------------------------|------|
...
```
***
# <span style="color:#CCFF33;">**Using Color:**</span>
...
<span style="color:#FFCC00;">#FFCC00</span>

<span style="color:#FF9900;">#FF9900</span>

<span style="color:#FF6600;">#FF6600</span>

<span style="color:#FF3300;">#FF3300</span>

<span style="color:#FF0066;">#FF0066</span>

<span style="color:#FF00CC;">#FF00CC</span>

<span style="color:#CC33CC;">#CC33CC</span>

<span style="color:#CC00FF;">#CC00FF</span>

<span style="color:#0033FF;">#0033FF</span>

<span style="color:#0066FF;">#0066FF</span>

<span style="color:#0099FF;">#0099FF</span>

<span style="color:#00CCFF;">#00CCFF</span>

<span style="color:#00FF99;">#00FF99</span>

<span style="color:#00FF33;">#00FF33</span>

<span style="color:#33CC00;">#33CC00</span>

<span style="color:#66FF00;">#66FF00</span>
